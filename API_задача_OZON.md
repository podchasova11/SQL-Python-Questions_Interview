...
Для тестирования хендлера, который отображает последний заказ в личном кабинете в формате JSON, необходимо проверить несколько ключевых бизнес-сценариев. Вот три основных сценария, которые следует проверить в первую очередь:

### Три основных бизнес-сценария
...
### Пример структуры ответа в виде JSON
